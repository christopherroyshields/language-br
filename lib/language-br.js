...
module.exports = {
  ...
  config: {
    ...
    "automaticCompile": {
       "description": "Automatically compile any .brs files any time you save them.",
       "type": "boolean",
       "default": "false"
    },

    "ignoreFolder": {
       "description": "Never Automatically Compile programs in this folder (Use for ScreenIO Event Functions).",
       "type": "string",
       "default": "function"
    },
  },
    ...
    atom.workspace.observeActiveTextEditor((editor)=>{
      ...
      if (editor){
        ...
        if (path.extname(prog)===".brs" || path.extname(prog)===".wbs"){
          ...
          // show auto compile statusbar item

          // check if autoCompile is active
