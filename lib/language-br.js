...
module.exports = {
  ...
  config: {
    ...
    "Lexi Menu Position": {
      "description": "Should the Lexi tools for Compile be placed at the Top or under Packages.",
      "type": "string",
      "default": "both",
      "enum": [
        {value: 'both', description: 'Lexi Menu in Both Places'},
        {value: 'top', description: 'Lexi Menu at Top Level'},
        {value: 'packages', description: 'Lexi Menu under Packages Menu'}
      ],
      radio: true
    },

    "Include FileIO Snippets": {
      "description": "Include FileIO Code Snippets.",
      "type": "boolean",
      "default": true
    },

    "Include ScreenIO Snippets": {
      "description": "Include ScreenIO Code Snippets.",
      "type": "boolean",
      "default": true
    },

    "Include Lexi Snippets": {
