...
module.exports = {
  ...
  activate(state) {
    ...
    //     'language-br:show-function-hint': (e) => {
    //       let
    ...
    //           this.functionHint.show(editor, e.newBufferPosition)
    //         })
    //
    //         cursor.onDidDestroy((e) =>{
    //           this.functionHint.hide(editor, e.newBufferPosition)
    //         })
    //
    //         const bufferPosition = cursor.getBufferPosition()
    //         this.functionHint.show(editor, bufferPosition)
    //       }
    //     }
    //   })
    // )
