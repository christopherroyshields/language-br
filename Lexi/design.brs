 ...
 CREATENEWFUNCTION: ! Creates A New Blank Function File
    def Fncreatenewfunction(Function$*255;FunctionType,SubType,___,Filename$*255,Filenumber)
 !
 ...
 !
       if ~Exists(Filename$) then
          ...
          if File(Filenumber)=0 then
             ...
             if FunctionType=2000+sf_function and SubType=4 then
                print #Filenumber:
                print #Filenumber:
                print #Filenumber: " ! This function is run before the listview starts loading. Put any code here"
                print #Filenumber: " !  that you need to run prior to loading the listview."
                print #Filenumber: " def "&fnGetSpecialFunctionName$("fn"&Function$,"Init_")
                print #Filenumber:
                print #Filenumber:
                print #Filenumber: " fnend"
                print #Filenumber:
                print #Filenumber: " ! This function is run after the listview has finished loading. Put any code here"
                print #Filenumber: " !  that you want to run when the listview finishes populating."
                print #Filenumber: " def "&fnGetSpecialFunctionName$("fn"&Function$,"Final_")
                print #Filenumber:
                print #Filenumber:
                print #Filenumber: " fnend"
             end if
    ...
    def fnPrintCustomFunctionComment(FileNumber,FunctionType,SubType)
       print #Filenumber: " !"
       print #Filenumber: " ! Fill in the comment above with a description of what this"
       print #Filenumber: " ! particular function does."
       print #Filenumber: " !"
       print #Filenumber: " !"
       #Select# FunctionType #Case# 0
       #Case# 1000+si_enterfn
          print #Filenumber: " ! This is an Enter Event Function. When selected as the Enter"
          print #Filenumber: " ! Event for your screen, this function runs after the screen"
          print #Filenumber: " ! has loaded but before the screen is drawn and before the"
          print #Filenumber: " ! record is read."
       #Case# 1000+si_initfn
          print #Filenumber: " ! This is an Initialize Event Function. When selected as the Init"
          print #Filenumber: " ! Event for your screen, this function runs only when the user is"
          print #Filenumber: " ! adding a new record to the data file. Use this event in your Add/Edit"
          print #Filenumber: " ! screens to initialize the new record and preform any other tasks that"
          print #Filenumber: " ! need to run each time a record is added. It is not run when Reading"
          print #Filenumber: " ! an existing record (See the Read Event for that)."
       #Case# 1000+si_readfn
          print #Filenumber: " ! This is a Read Event Function."
          print #Filenumber: " ! "
          print #Filenumber: " ! When used in an Add/Edit screen, this function runs"
          print #Filenumber: " ! only when the user is editing an existing record in"
          print #Filenumber: " ! a data file. Use this event to unpack the new record"
          print #Filenumber: " ! and preform any other tasks that need to run at read time."
          print #Filenumber: " ! This function runs just after the record is read. It is"
          print #Filenumber: " ! not run when Adding a record. (See Initialize Event)"
          print #Filenumber: " !"
          print #Filenumber: " ! When used in a Listview screen, this function runs each time"
          print #Filenumber: " ! the user's selection on the listview has changed. You can use it"
          print #Filenumber: " ! to update related fields when the listview selection changes"
          print #Filenumber: " ! in realtime. It can slow things down, so use it with caution"
          print #Filenumber: " ! and make sure your code here is as effecient as possible."
       #Case# 1000+si_loadfn
          print #Filenumber: " ! This is a Load Event Function. It runs after the record is"
          print #Filenumber: " ! read and the screen has finished loading, but before the"
          print #Filenumber: " ! screen is run. Use it to perform user interactions and other"
          print #Filenumber: " ! tasks that you want to run after the screen is drawn and"
          print #Filenumber: " ! before starting your program."
       #Case# 1000+si_writefn
          print #Filenumber: " ! This is a PreWrite Event Function. When used in an Add/Edit screen,"
          print #Filenumber: " ! this function runs only when the user exited the screen and chose"
          print #Filenumber: " ! to save the data. This function is run before the data is written."
          print #Filenumber: " !"
          print #Filenumber: " ! This is a good place to do full record validations that can't be"
          print #Filenumber: " ! done as you're going along. You can cancel the Exit by setting"
          print #Filenumber: " ! ExitMode to 0."
       #Case# 1000+si_waitfn
          print #Filenumber: " ! This is a Wait Event Function. It is called when the user has"
          print #Filenumber: " ! been idle for a long time (configurable in Screen Attributes)."
          print #Filenumber: " ! If not specified, the default ScreenIO Idle Message window"
          print #Filenumber: " ! appears instead. Ues this function to change the default"
          print #Filenumber: " ! idle behavior for your program."
       #Case# 1000+si_lockedfn
          print #Filenumber: " ! This is a Locked Event Function. Use this to override the default"
          print #Filenumber: " ! ScreenIO Locked Record behavior. This is run whenever a user attempts"
          print #Filenumber: " ! to edit a record but the record is locked (currently being edited) by"
          print #Filenumber: " ! another user."
       #Case# 1000+si_mergefn
          print #Filenumber: " ! This is a Merge Event Function. Its called when standard record"
          print #Filenumber: " ! locking is disabled and instead multiple users are allowed to"
          print #Filenumber: " ! edit the record, and the system attempts to merge their changes."
          print #Filenumber: " ! If you select that option, screenIO automatically merges the changes."
          print #Filenumber: " ! You can use this Merge function to override the default ScreenIO"
          print #Filenumber: " ! merging behavior."
       #Case# 1000+si_loopfn
          print #Filenumber: " ! This is a Main Loop Event Function. This code is run every time"
          print #Filenumber: " ! the user does anything on your screen. Use it to handle special"
          print #Filenumber: " ! user interactions such as custom Fkeys and double clicks."
       #Case# 1000+si_nokeyfn
          print #Filenumber: " ! This is a NoKey Event Function. This function is called"
          print #Filenumber: " ! any time the selected key is not found when attempting to"
          print #Filenumber: " ! edit. If this function is not specified, ScreenIO Defaults"
          print #Filenumber: " ! to displaying a message to the end user indicating that the"
          print #Filenumber: " ! key could not be found."
       #Case# 1000+si_prelistviewfn
          print #Filenumber: " ! This is a Pre-Listview Populate Event Function. When used in"
          print #Filenumber: " ! a Listview Screen, this code is run just prior to the listview"
          print #Filenumber: " ! being populated. Use this function to open related reference"
          print #Filenumber: " ! data files that you want to read during the populate, or to"
          print #Filenumber: " ! preposition the record pointer in the data file."
       #Case# 1000+si_postlistviewfn
          print #Filenumber: " ! This is a Post-Populate Listview Event Function. When used in"
          print #Filenumber: " ! a Listview Screen, this code runs just after the listview is"
          print #Filenumber: " ! populated. Use it to close data files you might have opened"
          print #Filenumber: " ! during Pre-Populate."
       #Case# 1000+si_exitfn
          print #Filenumber: " ! This is an Exit Event Function. You can use it to close data"
          print #Filenumber: " ! files that you opened during the Enter event. It runs when the"
          print #Filenumber: " ! screen is already closing, and the record has already been"
          print #Filenumber: " ! written. It is too late to cancel the close here."
       #Case# 2000+sf_function
          if ~SubType or SubType=1 then
             print #Filenumber: " ! This is a Click Event function. It runs when the user Clicks"
             print #Filenumber: " ! on the Control it is the click event for."
          else if SubType=2 then
             print #Filenumber: " ! This is a Validate Event Function. This function runs any time"
             print #Filenumber: " ! the control has been changed by the user."
             print #Filenumber: " !"
             print #Filenumber: " ! (To make it run as soon as it is changed, consider adding the"
             print #Filenumber: " ! ""X"" attribute to the control.)"
          else if SubType=3 then
             print #Filenumber: " ! This function is both the Populate and Validate functions"
             print #Filenumber: " ! for a Combo Box control. To use it, set the contents of an"
             print #Filenumber: " ! array called ReturnData$ and ScreenIO will populate that"
             print #Filenumber: " ! data into the Combo Box."
             print #Filenumber: " !"
             print #Filenumber: " ! It is also a Validate event, so make sure to have your function"
             print #Filenumber: " ! return true in order accept the users changes to the control."
          else if SubType=4 then
             print #Filenumber: " ! This function is the Filter function for the listview. It is run"
             print #Filenumber: " ! as the listview is being populated, and it runs once for every"
             print #Filenumber: " ! record in the data file, so be careful to make your code run as"
             print #Filenumber: " ! quickly as possible."
             print #Filenumber: " !"
             print #Filenumber: " ! Here you can unpack special fields from the data on disk to"
             print #Filenumber: " ! the listview if you want to, or color the row by returning html"
             print #Filenumber: " ! or an [ATTRIBUTE] substitution from your brconfig.sys (or"
             print #Filenumber: " ! settings.sys) file."
             print #Filenumber: " !"
             print #Filenumber: " ! You can also test the data and include or exclude rows in the data"
             print #Filenumber: " ! file. If your Filter function returns 1 (True) or non-blank (for example,"
             print #Filenumber: " ! a Color or [Attribute]), then the row is included in the listview."
             print #Filenumber: " ! If your function returns 0 (False) or Blank, then the row is excluded."
             print #Filenumber: " !"
             print #Filenumber: " ! Make sure your filter function returns something. If you want to"
             print #Filenumber: " ! see all the rows in the list, make your function return 1 (True)."
             print #Filenumber: " !"
             print #Filenumber: " ! Use the fnInit_ and fnFinal_ functions below, to open and close any needed"
             print #Filenumber: " ! reference data files, initialize counters, and stuff like that."
          else if SubType=5 then
             print #Filenumber: " ! This function should not be used for Child Screen controls. Instead"
             print #Filenumber: " ! of linking to a custom function, use the field to pass in parameters"
             print #Filenumber: " ! to your Child Screen. "
          end if
       #Case# 2000+sf_cnvrtin
          print #Filenumber: " ! This is a ConvertIn Function. Normally, you would specify a"
          print #Filenumber: " ! ScreenIO Conversion Spec such as FMT(, PIC( or DATE( instead"
          print #Filenumber: " ! of linking to a custom function. This custom function won't"
          print #Filenumber: " ! be run by ScreenIO."
       #Case# 2000+sf_cnvrtout
          print #Filenumber: " ! This is a ConvertOut Function. It isn't supported yet."
          print #Filenumber: " ! This custom function won't be run by ScreenIO."
       #End Select#
    fnend
